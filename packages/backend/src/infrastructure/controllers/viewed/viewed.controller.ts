...
import { InterfacesTokens, MoviesFiltersDto } from '@infrastructure/common';
import { Routes, ViewedRoutes } from '@infrastructure/common';
...
import { CreateViewedDto, DeleteViewedDto } from '@infrastructure/common';
